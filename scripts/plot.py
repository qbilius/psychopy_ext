...
def sample_cmap(cmap='Paired', ncolors=2):
...
def pivot_plot(pivot, persubj=None, kind='bar', ncols=2, ax=None, title='',
    ...
    if persubj is not None:
        # calculate errorbars
        p_yerr = errorbars(ncols, yerr_type=yerr_type)
...
def matrix(matrix, matrix_labels, ax=None, title='',
...
def errorbars(persubj, ncols, yerr_type='sem'):
