...
class Control(object):
    def __init__(self, modules=None, cmd=False):
        # if cmd:
        #     self.run_cmd(modules)
        # else:
        #     self.create_app()
        pass
...
# From Python 2.7 under the Python Software Foundation License
# Copyfight Steven J. Bethard <steven.bethard@gmail.com>.
