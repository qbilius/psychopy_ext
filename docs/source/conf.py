# -*- coding: utf-8 -*-
#
# psychopy_ext documentation build configuration file, created by
# sphinx-quickstart on Wed Mar 13 12:42:28 2013.
#
...
# Possibly ignored since autodoc is not used anywhere
...
htmlhelp_basename = 'psychopy_extdoc'
...
latex_documents = [
  ('index', 'psychopy_ext.tex', u'psychopy\\_ext Documentation',
   u'Jonas Kubilius', 'manual'),
]
...
texinfo_documents = [
  ('index', 'psychopy_ext', u'psychopy_ext Documentation',
   u'Jonas Kubilius', 'psychopy_ext', 'One line description of project.',
   'Miscellaneous'),
]
