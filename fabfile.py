...
DL_DIR = "docs/source/_static/downloads"

DOCS_DIR = "docs"
HTML_DIR = "../psychopy_ext_docs"

BUILD_DIRS = (
    "dist",
    "build",
    #"../psychopy_ext_docs/html",
...
def bdist():
    ...
    #with _dist_wrapper():
    local("python setup.py bdist_wininst", capture=False)

@task
def sdist():
    """Package into distribution."""
    #with _dist_wrapper():
    local("python setup.py sdist --formats=gztar,zip", capture=False)
